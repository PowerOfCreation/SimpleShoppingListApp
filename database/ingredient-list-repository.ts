...
export class IngredientListRepository extends BaseRepository {
  ...
  /**
   * Get all ingredient lists with ingredient counts
   * Efficiently fetches shopping list overview data with total and completed counts
   * @returns Result containing array of shopping list overviews or error
   */
