...
// means the event is durably appended to its list's log - see
// EventRepository.AppendToList, called synchronously from
// EventController.SyncEvents. Routed by the verified Keycloak sub (StoredEvent.UserID),
